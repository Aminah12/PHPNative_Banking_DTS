...
<?php  
		...
		else
		{
			...
			while ($row)
			{
				echo "<form action='setortunai.php' method='POST'>";
				echo "Setor Tunai";
				echo "<table>";
				echo "<tr><td>no_rek</td>";
				echo "<td><input name='no_rek' readonly value='".$row['no_rek']."'></td></tr>";
				echo "<tr><td>saldo </td>";
				echo "<td><input name='saldo' readonly value='".$row['saldo']."'></td></tr>";
				echo "<tr><td>Setor </td>";
				echo "<td><input type='text' name='strTunai'></td></tr>";
				echo "</tr>";
				echo "</table>";

				echo "<input type='submit' value='Setor' formtarget='_blank'>";
				$row = $tblhasil->fetch_assoc();
			}
		}
	?>
